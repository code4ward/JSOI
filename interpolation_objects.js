...
__nccwpck_require__.d(__webpack_exports__, {
  lw: () => (/* binding */ InterpolationValueNotFoundError),
  N5: () => (/* binding */ KeyValueContextI),
  $A: () => (/* binding */ ObjectInterpolator),
  at: () => (/* binding */ ObjectInterpolatorBase),
  g: () => (/* binding */ QueryObjKeyValueContextI),
  _J: () => (/* binding */ ReplaceObjectAction),
  g8: () => (/* binding */ SimpleTagParser),
  SR: () => (/* binding */ SinglePassTagReplacer),
  PH: () => (/* binding */ StringInterpolator)
});

;// CONCATENATED MODULE: ./src/expression_parser.js
...
;// CONCATENATED MODULE: ./src/interpolation_objects.js

//---------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------
const interpolation_objects_REGX = Object.freeze({
    FUNCTION_TAG: '^\\s*->\\s*(.*)',
...
class ObjectInterpolatorBase  {
    ...
    getCmdInKey(key) {
        ...
        if(ObjectInterpolatorBase.isKeyCmd(key, interpolation_objects_REGX.CMD_KEY_QUEUE_DEL_CHILD_OBJ_IF_EMPTY))
            cmd = KeyCommands.KeyCmdQueueDelChildObjectIfEmpty
        else if(ObjectInterpolatorBase.isKeyCmd(key, interpolation_objects_REGX.CMD_KEY_COPY_INTO_OBJ))
            cmd = KeyCommands.KeyCmdCopyIntoObject;
        else if(ObjectInterpolatorBase.isKeyCmd(key, interpolation_objects_REGX.CMD_KEY_COPY_INTO_PARENT_OBJ))
...
class ObjectInterpolator extends ObjectInterpolatorBase {
    ...
    static getFunctionExpression(expression) {
        let result = "";
        if(expression) {
            const regX = new RegExp(interpolation_objects_REGX.FUNCTION_TAG)
...
var __webpack_exports__InterpolationValueNotFoundError = __webpack_exports__.lw;
var __webpack_exports__KeyValueContextI = __webpack_exports__.N5;
var __webpack_exports__ObjectInterpolator = __webpack_exports__.$A;
var __webpack_exports__ObjectInterpolatorBase = __webpack_exports__.at;
var __webpack_exports__QueryObjKeyValueContextI = __webpack_exports__.g;
var __webpack_exports__ReplaceObjectAction = __webpack_exports__._J;
var __webpack_exports__SimpleTagParser = __webpack_exports__.g8;
var __webpack_exports__SinglePassTagReplacer = __webpack_exports__.SR;
var __webpack_exports__StringInterpolator = __webpack_exports__.PH;
export { __webpack_exports__InterpolationValueNotFoundError as InterpolationValueNotFoundError, __webpack_exports__KeyValueContextI as KeyValueContextI, __webpack_exports__ObjectInterpolator as ObjectInterpolator, __webpack_exports__ObjectInterpolatorBase as ObjectInterpolatorBase, __webpack_exports__QueryObjKeyValueContextI as QueryObjKeyValueContextI, __webpack_exports__ReplaceObjectAction as ReplaceObjectAction, __webpack_exports__SimpleTagParser as SimpleTagParser, __webpack_exports__SinglePassTagReplacer as SinglePassTagReplacer, __webpack_exports__StringInterpolator as StringInterpolator };
